...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow hover:bg-primary-hover hover:shadow-lg hover:scale-105",
        destructive:
        ...
        hero: "bg-primary text-primary-foreground shadow-lg hover:bg-primary-hover hover:shadow-xl hover:scale-105 glow-primary font-semibold",
        "secondary-hero": "bg-secondary text-secondary-foreground shadow-lg hover:bg-secondary-hover hover:shadow-xl hover:scale-105 glow-secondary font-semibold",
      },
      size: {
